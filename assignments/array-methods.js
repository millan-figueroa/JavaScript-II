...
// Problem 1
//Organizes companies in terms of donation size
let bigDoners = runners.filter(person => person.donation > 125)
let smallDoners = runners.filter(person => person.donation < 25)
let vipCompanies = bigDoners.map(a => a.company_name)
let regCompanies = smallDoners.map(a => a.company_name)
console.log(vipCompanies)
console.log(regCompanies)
console.log(bigDoners.length)
console.log(smallDoners.length)

// Problem 2
//returns the names of companies
...
// Problem 3
// Retrieves emails of each runner.
let emails = [];
runners.forEach(function(currentValue) {
